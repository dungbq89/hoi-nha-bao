        ...
        <div class="sct sidebar" id="right1">
            <div class="sct pictures" rel="38" id="ta38">
                ...
                <div class="slidebox" id="dslide">
                    <a href="javascript:djSlide.clickNext('dslide')" class="next" title="Next">Bài tru?c</a>
                    ...
                    <div id="dslide_1" style="display: block; opacity: 1;">
                        <a href="/diem-den/nhung-trai-nghiem-thu-vi-khong-nen-bo-lo-khi-den-sa-pa/99720.htm"><img src="http://i.baohatinh.vn/news/1531/106v99720l1.jpeg"><b><span>Nh?ng tr?i nghi?m thú v? không nên b? l? khi d?n Sa Pa</span></b></a>
                    </div>
                    <div id="dslide_2" style="display: none; opacity: -0.05;">
                        <a href="/diem-den/vong-quanh-the-gioi-ngam-canh-binh-minh-tuyet-dep/99708.htm"><img src="http://i.baohatinh.vn/news/1531/106v99708l1.jpeg"><b><span>Vòng quanh th? gi?i ng?m c?nh bình minh tuy?t d?p</span></b></a>
                    </div>
            ...
            <div class="contact">
                <ul>
                    <li class="email">
                        ...
                        | <a onclick="dj('#quick-mail').show();return false" href="#" title="Liên h?">Liên h?</a>
                    </li>
                    <li class="phone">
                        <span>Ðu?ng dây nóng</span>
                        <a title="Ði?n tho?i nóng" onclick="dj('#quick-phone').show();return false" href="#">Ðu?ng dây nóng: <b>0393.693.427</b></a>
                    </li>
                </ul>
            </div>
        </div>
