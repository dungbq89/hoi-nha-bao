...
if (isset($articles) && $articles):
    ...
    <div class="sct featured">
        <div class="atc featured picture">
            <div style="background-image: url(<?php echo VtHelper::getThumbUrl($path, 460, 268, '') ?>); background-size: cover;height: 268px;" class="cover dthumb" >
                <a href="<?php echo url_for2('article_detail',array('slug'=>$articles[0]['slug'])) ?>"></a>
            </div>
            <div class="hed">
                <h1><a href="<?php echo url_for2('article_detail',array('slug'=>$articles[0]['slug'])) ?>"><?php echo htmlspecialchars($articles[0]['alttitle']); ?></a></h1>
        ...
        <?php if (count($articles) > 1): ?>
                ...
                <div class="atc dor" style="<?php if($i==3) echo 'margin-right: 0px'; ?>">
                    <a href="<?php echo url_for2('article_detail',array('slug'=>$articles[$i]['slug'])) ?>">
                        <img style="height:100px;" src="<?php echo VtHelper::getThumbUrl($pathi, 150, 100, '') ?>">
                    </a>
                    <div class="hed"><h1><a href="<?php echo url_for2('article_detail',array('slug'=>$articles[$i]['slug'])) ?>"><?php echo htmlspecialchars($articles[$i]['alttitle']); ?></a></h1></div>
                </div>
    ...
    <div class="item item-lastest-news">
        ...
        <?php if (count($articles) > 4): ?>
            <ul class="box-scroll mCustomScrollbar">
                ...
                <li>
                    <a href="<?php echo url_for2('article_detail',array('slug'=>$articles[$i]['slug'])) ?>" title="<?php echo htmlspecialchars($articles[$i]['title']); ?>"><?php echo htmlspecialchars($articles[$i]['alttitle']); ?></a>
                </li>
                <?php endfor; ?>
            </ul>
        <?php endif; ?>
