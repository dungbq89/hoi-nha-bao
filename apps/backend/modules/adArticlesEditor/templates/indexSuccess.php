    ...
    <div class="row-fluid">
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <div id="sf_admin_content">
                                    <form class="form-inline" id="list-form" action="<?php echo url_for('ad_article_collection', array('action' => 'batch')) ?>" method="post">
                ...
                <div>
                    ...
                    <?php if(sfContext::getInstance()->getUser()->hasCredential('admin') || sfContext::getInstance()->getUser()->hasCredential('news_editor')):?>
                        <div class="well pull-left margin-right"><?php include_partial('adArticlesEditor/list_actions', array('helper' => $helper)) ?></div>
                    <?php endif; ?>
                </div>
                                    </form>
                    ...
                    <div class="well pull-right">
                      <?php echo __('Số bản ghi/trang: ')?>
                        <?php $select = new sfWidgetFormChoice(array(
                                    ...
                                    array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('adArticlesEditor.max_per_page', null, 'admin_module')) ?>
