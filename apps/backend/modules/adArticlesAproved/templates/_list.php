<div class="sf_admin_list">
    <table class="datatable table table-bordered table-striped" id="table_vt_manage_article_approved" style="margin-top: 5px !important;">
      <thead>
          <tr>
      ...
      <tfoot>
        <tr>
          <th colspan="8">
            ...
            <div style="position: relative; width: auto; float:right"><?php include_partial('adArticlesAproved/pagination', array('pager' => $pager)) ?></div>
