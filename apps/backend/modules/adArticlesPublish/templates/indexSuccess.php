    ...
    <div class="row-fluid">
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <div id="sf_admin_content">
                                    <form class="form-inline" id="list-form" action="<?php echo url_for('ad_article_adArticlesPublish_collection', array('action' => 'batch')) ?>" method="post">
                ...
                <form class="form-inline" method="get" action="<?php echo url_for('ad_article_adArticlesPublish') ?>">
                    <div class="well pull-right">
                      <?php echo __('Số bản ghi/trang: ')?>
                        <?php $select = new sfWidgetFormChoice(array(
                                    ...
                                    array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('adArticlesPublish.max_per_page', null, 'admin_module')) ?>
