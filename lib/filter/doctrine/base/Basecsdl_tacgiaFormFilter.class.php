...
/**
 * csdl_tacgia filter form base class.
 *
 * @package    Web_Portals
 * @subpackage filter
 * @author     ngoctv1
 ...
 */
abstract class Basecsdl_tacgiaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('csdl_tacgia_filters[%s]');
