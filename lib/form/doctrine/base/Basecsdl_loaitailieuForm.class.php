...
/**
 * csdl_loaitailieu form base class.
 *
 * @method csdl_loaitailieu getObject() Returns the current form's model object
 *
 * @package    Web_Portals
 * @subpackage form
 * @author     ngoctv1
 ...
 */
abstract class Basecsdl_loaitailieuForm extends BaseFormDoctrine
{
