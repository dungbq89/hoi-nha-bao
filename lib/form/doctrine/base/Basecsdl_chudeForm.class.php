...
/**
 * csdl_chude form base class.
 *
 * @method csdl_chude getObject() Returns the current form's model object
 *
 * @package    Web_Portals
 * @subpackage form
 * @author     ngoctv1
 ...
 */
abstract class Basecsdl_chudeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'         => new sfWidgetFormInputHidden(),
      'tenchude'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tenchude'   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
